...
##  ========
##
##  Include file for SDL API procedures that don't fit elsewhere.

proc openURL*(url: cstring): cint {.
    cdecl, importc: "SDL_OpenURL", dynlib: SDL2_LIB.}
  ##  Open an URL / URI in the browser or other.
  ##
  ...
  ##
  ##  All this to say: this procedure can be useful, but you should definitely

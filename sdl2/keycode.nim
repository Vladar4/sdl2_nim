...
template scancodeToKeycode*(x: expr): Keycode =
  (cint(x) or K_SCANCODE_MASK)

const
  K_UNKNOWN*: Keycode = 0
  K_RETURN*: Keycode = ord '\x0D'
  K_ESCAPE*: Keycode = ord '\x1B'
  K_BACKSPACE*: Keycode = ord '\x08'
  K_TAB*: Keycode = ord '\x09'
  K_SPACE*: Keycode = ord ' '
  K_EXCLAIM*: Keycode = ord '!'
  K_QUOTEDBL*: Keycode = ord '\"'
  K_HASH*: Keycode = ord '#'
  K_PERCENT*: Keycode = ord '%'
  K_DOLLAR*: Keycode = ord '$'
  K_AMPERSAND*: Keycode = ord '&'
  K_QUOTE*: Keycode = ord '\''
  K_LEFTPAREN*: Keycode = ord '('
  K_RIGHTPAREN*: Keycode = ord ')'
  K_ASTERISK*: Keycode = ord '*'
  K_PLUS*: Keycode = ord '+'
  K_COMMA*: Keycode = ord ','
  K_MINUS*: Keycode = ord '-'
  K_PERIOD*: Keycode = ord '.'
  K_SLASH*: Keycode = ord '/'
  K_0*: Keycode = ord '0'
  K_1*: Keycode = ord '1'
  K_2*: Keycode = ord '2'
  ...
  K_9*: Keycode = ord '9'
  K_COLON*: Keycode = ord ':'
  K_SEMICOLON*: Keycode = ord ';'
  K_LESS*: Keycode = ord '<'
  K_EQUALS*: Keycode = ord '='
  K_GREATER*: Keycode = ord '>'
  K_QUESTION*: Keycode = ord '?'
  K_AT*: Keycode = ord '@'
  #
  #       Skip uppercase letters
  #
  K_LEFTBRACKET*: Keycode = ord '['
  K_BACKSLASH*: Keycode = ord '\x08'
  K_RIGHTBRACKET*: Keycode = ord ']'
  K_CARET*: Keycode = ord '^'
  K_UNDERSCORE*: Keycode = ord '_'
  K_BACKQUOTE*: Keycode = ord '`'
  K_a*: Keycode = ord 'a'
  K_b*: Keycode = ord 'b'
  K_c*: Keycode = ord 'c'
  K_d*: Keycode = ord 'd'
